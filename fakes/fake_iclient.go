...
type FakeIClient struct {
	DeleteStub        func(ctx context.Context, payload interface{}) (int, error)
...
func (fake *FakeIClient) Delete(ctx context.Context, payload interface{}) (int, error) {
	...
	fake.recordInvocation("Delete", []interface{}{ctx, payload})
	fake.deleteMutex.Unlock()
	if fake.DeleteStub != nil {
		return fake.DeleteStub(ctx, payload)
	}
	if specificReturn {
...
func (fake *FakeIClient) DeleteArgsForCall(i int) (context.Context, interface{}) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
	return fake.deleteArgsForCall[i].ctx, fake.deleteArgsForCall[i].payload
}
